...
{$ENDIF}
       ...
       Presentation1='FONCOLO';
       Presentation2='PRESMAX2';
       ...
       LittleImageExtension = 'png' ;
       ImageExtension = '.' + LittleImageExtension ;
...
function  ChargeLUM(const Chemin : String;NoNiveau:integer; var TailleX, TailleY : Integer; var Briques : TCases ):String;
function  SauveLUM(const Chemin : String;NoNiveau:integer; var TailleX, TailleY : Integer; const Briques : TCases ):String;
...
begin
  ...
  If (IOResult=0) and (i<>NoNiveau)
    Then
      Result := 'Ce niveau n''existe pas ! ' + #13#10 + 'Dernier niveau :' + IntToStr(I);
  {$I-}
  CloseFile(Fichier);
  {$I+}
  //TailleX:=EnTeteFichier.TailleX;
...
begin
  ...
  if ((I=NoNiveau) or eof(Fichier)) and (IOResult=0) then
     begin
      ...
      else Result := 'Le niveau n''a pas pu être sauvé. Le numéro du niveau est trop élevé';
  {$I-}
  CloseFile(Fichier);
  {$I+}
end;
